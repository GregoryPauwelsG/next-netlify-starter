  ...
  return (
    <div className="container">
      ...
      <main>
        ...
        <p>Website deployed to Netlify to mock the behaviour of a real website. Netlify provides a development platform for web applications and dynamic websites </p>
